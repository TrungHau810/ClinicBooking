# Generated by Django 5.1.7 on 2025-05-31 01:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('disease_type', models.TextField(choices=[('HoHap', 'Đường hô hấp'), ('TieuHoa', 'Đường tiêu hoá'), ('TK_TT', 'Thần kinh - Tâm thần'), ('Mat', 'Bệnh về Mắt'), ('ChanThuong', 'Chấn thương - chỉnh hình'), ('DaLieu', 'Da liễu'), ('TaiMuiHong', 'Tai - Mũi - Họng'), ('Khac', 'Khác')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('uu_dai', 'Ưu đãi'), ('kham_sk', 'Khám sức khoẻ định kỳ')], default='uu_dai', max_length=20)),
