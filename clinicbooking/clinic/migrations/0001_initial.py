# Generated by Django 5.1.7 on 2025-05-10 09:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('scheduled', 'Đã lên lịch'), ('completed', 'Đã khám'), ('cancelled', 'Đã hủy')], default='scheduled', max_length=20)),
                ('cancel_reason', models.TextField(blank=True, null=True)),
                ('rescheduled_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='clinic.appointment')),
